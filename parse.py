...
PROMPT = """Take the following voice transcription and format it into the following categories: What they do, Problems solved, Case study, and My initial take.
...
def create_prompt(keys: list[str], transcription: str) -> str:
    ...
    return PROMPT.format(keys_str=keys_str, transcription=transcription)
